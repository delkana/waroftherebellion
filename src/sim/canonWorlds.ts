...
export const CANON_WORLDS: CanonWorld[] = [
  ...
  { name: 'Scarif', x: 8713, y: -10197, grid: 'Q17', region: 'Outer Rim', type: 'ocean', production: 7, owner: null, lean: -0.6, shipyard: 0, defense: 1, garrison: 2 },
  ...
  { name: 'Hoth', x: -1421, y: -12880, grid: 'K18', region: 'Outer Rim', type: 'ice', production: 3, owner: null, lean: 0.2, shipyard: 0, defense: 0, garrison: 0 },
